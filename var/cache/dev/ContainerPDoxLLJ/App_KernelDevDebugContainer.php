...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\AddwordsController' => 'getAddwordsControllerService',
            'App\\Controller\\IndexController' => 'getIndexControllerService',
            'App\\Controller\\ListeningcompController' => 'getListeningcompControllerService',
            'App\\Controller\\OrthographyController' => 'getOrthographyControllerService',
            'App\\Controller\\PaneladminController' => 'getPaneladminControllerService',
            'App\\Controller\\ReadingcompController' => 'getReadingcompControllerService',
            ...
            'App\\Controller\\WordsLearnedController' => 'getWordsLearnedControllerService',
            'App\\Controller\\WordsTestController' => 'getWordsTestControllerService',
            'App\\Controller\\WordteststartController' => 'getWordteststartControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('sjIJyJc6gH', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wVJZ6cMHVk', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\ListeningRepository' => ['privates', 'App\\Repository\\ListeningRepository', 'getListeningRepositoryService', true],
            ...
            'App\\Repository\\WordsLearnedRepository' => ['privates', 'App\\Repository\\WordsLearnedRepository', 'getWordsLearnedRepositoryService', true],
            'App\\Repository\\WordsRepository' => ['privates', 'App\\Repository\\WordsRepository', 'getWordsRepositoryService', true],
            'App\\Repository\\WordsToLearnRepository' => ['privates', 'App\\Repository\\WordsToLearnRepository', 'getWordsToLearnRepositoryService', true],
        ], [
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kBUlySRITb', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('630w5m+5zN', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2zdRtqWe56', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gkePYzuxHL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2uY1Vk461q', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
