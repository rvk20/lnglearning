...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/WordTest.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/WordsToLearn.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\WordTest(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\WordsToLearn(), 'groups' => []]]);
