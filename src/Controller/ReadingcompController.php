...
class ReadingcompController extends AbstractController
{
    /**
     * @Route("/readingcomp", name="readingcomp")
     */
    public function index(Request $request, PaginatorInterface $paginator)
    {
        ...
        return $this->render('readingcomp/index.html.twig', [
            'quizs' => $quizs,
        ]);
    }

     /**
     * @Route("/readingcomp/{id}", name="readingtest", methods={"GET","HEAD", "POST"})
     */
    public function test(int $id): Response
    {
     ...
     if(isset($_POST['submit'])){
         ...
         $session->setType("Czytanie ze zrozumieniem");
     ...
     return $this->render('readingcomp/test.html.twig', [
         'quiz' => $quiz,
         'language' => $language,
         'text' => $text,
        ]);
